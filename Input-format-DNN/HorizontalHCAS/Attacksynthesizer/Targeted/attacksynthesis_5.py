...
def find_delta(inputs_to_change):
    ...
    nn.addConstr(denormalizedOuts[1] <= denormalizedOuts[2])
    nn.addConstr(denormalizedOuts[2] <= denormalizedOuts[0])
    nn.addConstr(denormalizedOuts[2] <= denormalizedOuts[3])
    nn.addConstr(denormalizedOuts[2] <= denormalizedOuts[4])
